...
class MusicQuestions(Question):
    def __init__(self):
        ...
        {"question": "Vilken artist släppte låten 'Doja Cat'?", 
        "options": ["A) Harry Styles", "B) Doja Cat",
                    "C) Kanye 'Ye' West", "D) Central Cee"], 
        "answer": "D) Central Cee"},
        
        {"question": "Vilken pop stjärna håller rekordet för flest veckor som nummer 1 på Billboard Hot 100 med en enda låt?", 
        ...
        {"question": "2022 släppte Jack Harlow sin virala låt First Class som sampler denna tidigt 2000-tals hit låt.", 
        ...
        {"question": "Vilket bands frontman vart kallad 'the voice of a generation' efter att de släppte sitt 1991 album Nevermind?", 
        "options": ["A) Pearl Jam", "B) Nirvana", "C) Soundgarden", "D) Smashing Pumpkins"], 
        "answer": "B) Nirvana"},
        
        {"question": "Vilket 2000-tals rockband samplade från en James Bond-film?", 
        "options": ["A) The White Stripes", "B) System of a Down", "C) Linkin Park", "D) My Chemical Romance"], 
        "answer": "C) Linkin Park"},
        
        {"question": "Vilket Heavy Metal-band blev stämda på 90-talet för att ha haft undermedvetna meddelanden i deras låtar, vilket ledde till att ett fan dog?", 
        "options": ["A) Metallica", "B) Judas Priest", "C) Slayer", "D) Black Sabbath"], 
        "answer": "B) Judas Priest"},
        
        {"question": "Vad var Ozzy Osbournes smeknamn?", 
        ...
        {"question": "Vilken Reggae-legend begravdes med hans gitarr, en bibel, en ring, och en marijuanaknopp?", 
        "options": ["A) Peter Tosh", "B) Bob Marley", "C) Jimmy Cliff", "D) Toots Hibbert"], 
        "answer": "B) Bob Marley"},
        
        {"question": "Vilken Jazzmusiker är känd för att ha varit pionjär inom bebop tillsammans med Charlie Parker på 40-talet?", 
